...
} from "../../../backend/matchingAlgorithm/matchingAlgo";
    ...
    return (
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <div className="flex items-center justify-between px-4 py-6">
                <button className="flex items-center text-blue-600 border border-blue-600 rounded px-4 py-2 hover:bg-blue-50 transition">
            ...
            <section className="bg-gray-100 pt-16 px-4 pb-12">
                <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8"></div>
            </section>
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-30 z-50">
                    <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md text-center">
                        ...
                        <div className="flex justify-between">
                            ...
                            >
                                Send{" "}
                                <PaperAirplaneIcon className="ml-2 mb-1 h-4 w-4 rotate-45" />
                            </button>
                        </div>
                    </div>
                </div>
