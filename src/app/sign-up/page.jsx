            ...
            <div className="min-h-screen flex flex-col bg-[#E8F6FF] overflow-hidden">
                ...
                <div className="flex-grow flex items-center justify-center">
                    <div className="w-[502px] space-y-4">
                        <h1 className="text-4xl font-secondary font-bold text-[40px] m-8 text-center">
                            Sign up
                        </h1>

                        {/* Email Input */}
                        <p className="text-left font-secondary text-[20px]">Email</p>
                        <TextBox
                            type="text"
                            Placeholder="Email"
                        ...
                        {/* Password Input */}
                        <p className="text-left font-secondary text-[20px]">Password</p>
                        <TextBox
                            type="password"
                        ...
                        {/* School Dropdown */}
                        <p className="text-left font-secondary text-[20px]">
                            School Information
                        </p>
