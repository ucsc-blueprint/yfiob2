            ...
            <div className="bg-white h-full rounded-b-[20px] p-[5vh] flex flex-col justify-center overflow-y-auto overlfow-x-hidden">
                ...
                <div className="flex-col flex items-center grow relative mb-14">
                    <div className="flex-[3] w-[77%] flex items-start gap-4 mr-14 -ml-5">
                        {/* Fixed size circle */}
                        <div
                            className={`flex items-center justify-center text-white w-10 h-10 rounded-full ${bgColor} flex-shrink-0`}
                        >
                            {questionNumber}
                        </div>
                        ...
                        <div className="flex flex-col min-h-[140px] justify-between">
                            ...
                            <p className="text-[17px] text-gray-400">
                                Please select how strongly you agree/disagree with this
                                statement
                            </p>
                        </div>
                        ...
                        <img
                            className="absolute right-0 w-[20%] min-w-[80px] max-w-[100px]"
                            src={`${puzzleImg}`}
                            alt="Jigna Small"
                        />
                    </div>
