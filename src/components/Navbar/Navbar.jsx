        ...
        <div className="bg-white shadow-md">
            <div className="flex items-center justify-between px-6 h-[20vw] md:h-auto">
                ...
                <div className="font-lato">
                    ...
                    <Link
                        href={"/pre-quiz"}
                        className="px-3 hover:text-[#4C78E7] py-1 text-[1.1rem]"
                    >
                        Take Quiz!
                    </Link>
                    <Link
