  ...
  if (educationLevel === 'elementary-school') {
    ...
    return (
      <div className="no-scrollbar overflow-y-auto bg-white rounded-tr-xl rounded-b-xl border-black border-2  w-[240px] h-[250px] font-lato ">
        <header className='p-3 text-center text-[20px] font-bold text-lg pd-[0.7em]'> Bob </header>
    ...
    return (
      <div className="no-scrollbar overflow-y-auto bg-white rounded-3xl w-[240px] h-[250px] rounded-15px pb-1em font-lato ">
        ...
        <header className='pt-2 pb-2 bg-[#3FA1D9] text-center text-[22px] font-bold text-lg pd-[0.7em]'> Bob </header>
        :
        // Header for high-school level
        <header className="pt-2 pb-2 bg-[#47B748] text-center text-[22px] font-bold text-lg pd-[0.7em]">Bob</header>
        }
