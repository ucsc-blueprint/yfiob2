...
import { render, screen, fireEvent, getByTestId, getByAltText, getAllByTestId} from "@testing-library/react";
...
describe("CareersCardExpanded", () => {
  describe("Elementary School", () => { // elementary block
    beforeEach(() => {
      render(  // renders components for each grade level
        <CareersCardExpanded
    ...
    test("elementary school header color", () => {
      expect(screen.getByTestId('careers-header')).toHaveStyle('background-color: #EACAA5');
    });
  ...
  describe("Middle School", () => { // middle school block
    ...
    test("middle school header color", () => {
      expect(screen.getByTestId('careers-header')).toHaveStyle('background-color: #3FA1D9');
    });
  ...
  describe("High School", () => { // high school block
    ...
    test("scrollbar time", () => {
      fireEvent.scroll(screen.getByTestId("careers-card-expanded-container"), { target: { scrollY: 500 } });
    });

    // Header Color Test
    test("high school header color", () => {
      expect(screen.getByTestId('careers-header')).toHaveStyle('background-color: #47B748');
    });
