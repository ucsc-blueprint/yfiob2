  ...
  return (
    <div className="flex-auto w-11/12 m-auto justify-center align-middle relative top-20 left-0">
      <div className="overflow-y-auto">
        <h4 className = "bg-[#47B748] max-w-fit italic px-[2em] py-[0.3em] rounded-[10px_10px_0px_0px] border-solid border-[black]">{category}</h4>
      </div>
      <div className="bg-white p-4 h-5/6 rounded-tr-[17px]">
      ...
      */}
        <h2 className="font-bold text-xl ml-[00px] mr-0 mt-0 mb-2.5">{careerName}</h2>
        <p>Description:</p>
        <p>{description}:</p>
        <p>Salary:</p>
        <p>{salary}</p>
      ...
      <img src="/jignaSmall.png" alt="Jigna Small" className = "jignaSmall w-[63.19] h-[57.42px] ml-auto object-scale-down"/>
      </div>
    </div>
  );
};
