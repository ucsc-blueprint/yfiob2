		...
		<div className="bg-white shadow-md font-lato">
			<div className="flex items-center justify-between p-6 h-[20vw] md:h-auto">
				...
				<div className="hidden md:flex space-x-6">
					<a href="/" className="px-3 hover:text-[#4C78E7] py-1">
						Home
					</a>
					<a href="/take-quiz" className="px-3 hover:text-[#4C78E7] py-1">
						Take Quiz!
					</a>
					<a href="/explore-careers" className="px-3 hover:text-[#4C78E7] py-1">
						Explore Careers
					</a>
				</div>
